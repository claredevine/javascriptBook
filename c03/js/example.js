/* The script is placed inside an immediately invoked function expression (IIFE)
  which helps protect teh scope of the variables */
...
(function(){
  ...
  elEnds = document.getElementById('offerEnds'); //Get the offerEnds variable
  elEnds.innerHTML = offerExpires(today); //Add the expiray message
